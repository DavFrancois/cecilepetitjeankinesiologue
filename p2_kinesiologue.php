...
<html lang="fr">
	<head> <!-- Entête de la page -->
        ...
        <meta name="description" content="Présentation de la kinésiologie. Réservation d'une scéance en ligne avec Cécile PETITJEAN, kinésiologue certifiée.">
        <meta name="keywords" content="Cécile PETITJEAN, kinésiologue, kinesiologie, sophrologie, Saint-Malo, Médecine alternative, apprentissage, peurs, phobies, relation aux autres, trouble, sommeil, stress, confiance, soi, santé, maux, corps, estime, comportements, alimentaires, énergie, éducation, devoirs, enfants">
        ...
        <header class ="header">
            ...
            <section>
				...
				<article>
                    ...
                    <div class="pair">
                        <h2>La kinésiologie, ça sert à quoi ?</h2>
                        ...
                        <ul>
                            ...
                            <li>Mettre des mots sur ses <strong>maux</strong> pour s’en libérer.<figure class="figure_right_large">
                                <img class="figure_photo" src="images/trianglesante.png" alt="I can do it" title="I can do it - Cécile PETITJEAN"/>
                            </figure></li>
