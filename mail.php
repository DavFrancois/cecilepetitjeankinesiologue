	...
	$email_expediteur = 'cecilepetitjeankinesiologue@gmail.com';
	$nom_expediteur = ' Cecile cecilepetitjeankinesiologue.com';
	...
	$destinataire = 'cecilepetitjeankinesiologue@gmail.com';
...
; // fin du if (!isset($_POST['envoi']))
    ...
    /*
    $retour = mail('dfrancois@yahoo.fr', 'Envoi depuis la page Contact', $_POST['message'], 'From: cecilepetitjeankinesiologue@gmail.com');
    if ($retour)
